...
Act's authority base and are not reproduced here. **Status.** Compiled 20 August 2026 from
the tagged v3.4 source files. Pincites are given where the source gives them; an entry that
lacks a pincite remains to be checked before introduction. Nothing in this table is a new
substantive claim.
...
| *Liu v. SEC*, 591 U.S. 71 (2020) | n.18 | Equitable disgorgement confined to net profits for victims — destination logic adopted by choice |
...
§ 7.06 against an ALI print (mirror-pinned only); the Ohio § 2929.14(C)(4)(a)–(c) subclauses
verbatim; text for Ind. Const. art. 1, § 16 and W. Va. Const. art. III, § 5; the Illinois
Act's ILCS compilation cite; *Monsanto v. Durnell*'s U.S. Reports pagination; and the NSW
s 272A penalty-unit maxima from primary. Everything else above has been read against a
primary or first-party source at some point in the record; this table does not re-verify,
it locates.

*Compiled 20 August 2026 against the v3.4 tag. Corrections to
FrontierAIAccountabilityProject@proton.me; they enter the errata register like everything else.*
